...
public final class CustomCape extends Module {
    ...
    public static void loadCapes() {
        ...
        for (String s : builtinCapes) {
            ...
            try {
                InputStream stream = Rug.class.getResourceAsStream("/assets/keystrokesmod/textures/capes/" + name + ".png");
                if (stream == null)
                    stream = Rug.class.getResourceAsStream("/assets/keystrokesmod/textures/capes/" + s + ".png");
                if (stream == null)
                    continue;
